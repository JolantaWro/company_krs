...
const Company = ({ company }) => {
    ...
    return (
        <div className="content">
            ...
            {company.codePKD === "Brak danych w KRS" ? null : 
            ...
            {company.resultsDateFinancial === "Brak danych w KRS" ? null : 
