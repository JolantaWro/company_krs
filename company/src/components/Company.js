...
const Company = ({ company }) => {
    ...
    return (
        <div className="content">
            ...
            <p className="content__item text">Ostatnio opublikowane dane w KRS: <b>{company.results[company.results.length -1].zaOkresOdDo}</b></p>
            }

            {company.results === "" ? null : 
            <p className="content__item text">Data ostatnio opublikowanych danych: {company.results[company.results.length -1].dataZlozenia}r.</p>
            }
